import { Plus, Settings, Zap, MessageSquare } from "lucide-react";
...
const ArvoSidebar = ({ isOpen, onClose }: ArvoSidebarProps) => {
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-72 z-50 flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      >
        ...
        <div className="relative flex flex-col h-full glass-surface rounded-r-2xl lg:rounded-r-none">
          ...
          <div className="flex items-center gap-2.5 px-6 pt-6 pb-2">
            <div className="w-8 h-8 rounded-lg gradient-cta flex items-center justify-center glow-shadow">
          ...
          <div className="px-4 py-4">
            <button className="w-full flex items-center gap-2 px-4 py-2.5 rounded-xl gradient-cta text-primary-foreground text-sm font-medium glow-shadow hover:brightness-110 transition-all duration-300">
          ...
          {/* Bottom */}
          <div className="px-4 py-4 border-t border-luminous flex items-center gap-3">
